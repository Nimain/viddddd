...
function serverHandler(request, response) {
    ...
    try {
        ...
        var matched = false;
        ['/meeting/', '/dev/', '/dist/', '/socket.io/', '/node_modules/canvas-designer/', '/admin/'].forEach(function(item) {
        ...
        try {
            ...
            if (filename.search(/meeting/g) === -1 && filename.search(/admin/g) === -1 && stats.isDirectory() && config.homePage === '/meeting/index.html') {
        ...
        try {
            if (fs.statSync(filename).isDirectory()) {
                ...
                if (filename.indexOf(resolveURL('/meeting/MultiRTC/')) !== -1) {
                    filename = filename.replace(resolveURL('/meeting/MultiRTC/'), '');
                    filename += resolveURL('/meeting/MultiRTC/index.html');
                ...
                } else if (filename.indexOf(resolveURL('/meeting/dashboard/')) !== -1) {
                    filename = filename.replace(resolveURL('/meeting/dashboard/'), '');
                    filename += resolveURL('/meeting/dashboard/index.html');
                } else if (filename.indexOf(resolveURL('/meeting/video-conference/')) !== -1) {
                    filename = filename.replace(resolveURL('/meeting/video-conference/'), '');
                    filename += resolveURL('/meeting/video-conference/index.html');
                } else if (filename.indexOf(resolveURL('/meeting')) !== -1) {
                    filename = filename.replace(resolveURL('/meeting/'), '');
                    filename = filename.replace(resolveURL('/meeting'), '');
                    filename += resolveURL('/meeting/index.html');
                } else {
